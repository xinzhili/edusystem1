...
from ai_assistor.forms import StudentLoginForm
from ai_assistor.models import Student
...
def custom_login(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                 ...
                 return render(request, "ai_assistor/login.html")  # 重新渲染登录页面，显示错误信息  
    ...
    return render(request, 'ai_assistor/login.html', {'form': form,'next': next_url})
